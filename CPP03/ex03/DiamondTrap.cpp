...
/*   Updated: 2023/08/08 17:44:06 by junlee2          ###   ########seoul.kr  */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << DIA << CRECOPY << " DiamondTrap " << _name << NONE
			  << std::endl;
}
...
{
	std::cout << DIA << DISTROY << " DiamondTrap " << _name << NONE
			  << std::endl;
}

void DiamondTrap::whoAmI(void)
{
	std::cout << DIA << "This DiamondTrap name is " << _name
			  << " and This ClapTrap name is " << ClapTrap::_name << NONE
			  << std::endl;
}
